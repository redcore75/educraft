...
public class GlobalConstants {
	...
	public static final String MEBMER_LEVEL_F_NOR = "10"; //회원(보통)
	public static final String MEBMER_LEVEL_F_TMP = "11"; //회원(휴면)
	public static final String MEBMER_LEVEL_R_NOR = "12"; //추천인
}
